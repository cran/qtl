...
INSTALLATION OF R AND R/QTL (Windows)
  ...
  1. The Windows version of R is distributed as a single file, with a
     name something like R-2.4.0-win32.exe.  Install R by executing
  ...
  2. To install R/qtl, the simplest approach is to start R and type
     ...
     Alternatively, you can download the "qtl.1.04-53.zip" (or the
     equivalent).  Then start R and select (on the menu bar)
     "Packages" and then "Install package from local zip file...".  
     Find the file "qtl_1.04-53.zip" on your hard drive, and click 
     "Open".


INSTALLATION OF R AND R/QTL (MacOS version 10.2.x and above)

  1. Download the file R-2.4.0.dmg and double-click it to create a
     "drive" with a name like "R-2.4.0".  Double-click on the file
  ...
  2. To install R/qtl, the simplest approach is to start R and type
     ...
     Mac OS X, a file like "qtl_1.04-53.tgz".  Then start R and 
